## The functions below is designed to minimize time spent computing the inverse
## large matrices.
...
makeCacheMatrix <- function(x = matrix()) {
        ...
        setInverse <- function(InverseMatrix_P) InverseMatrix <<- InverseMatrix_P        ## This function allows the cacheSolve to set
                                                                                        ## the InverseMatrix to it has calculated. The "_P" represents the matrix
...
cacheSolve <- function(x, ...) {
        inverseMatrix <- x$getInverse()                         ## Retrieve the inverse from the matrix.
                                                                ##  If the inverse matrix does not exist, it will retrieve NULL (as we put in the above)
